...
public class LauncherFiles {
    ...
    public static final String SHARED_PREFERENCES_KEY = "com.katsuna.launcher.prefs";
    public static final String MANAGED_USER_PREFERENCES_KEY = "com.katsuna.launcher.managedusers.prefs";
    // This preference file is not backed up to cloud.
    public static final String DEVICE_PREFERENCES_KEY = "com.katsuna.launcher.device.prefs";
